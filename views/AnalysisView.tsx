            ...
            {feedbackState === 'submitted' ? (
                ...
                <>
                    ...
                    <div className="flex justify-center gap-6 mb-6">
                        <button onClick={handleThumbClick} className="p-4 bg-white rounded-full shadow-sm hover:bg-[#90BC6E] hover:text-white transition-all active:scale-95 border border-slate-100"><ThumbsUp size={24} /></button>
                        <button onClick={handleThumbClick} className="p-4 bg-white rounded-full shadow-sm hover:bg-[#E46B3F] hover:text-white transition-all active:scale-95 border border-slate-100"><ThumbsDown size={24} /></button>
                    </div>
